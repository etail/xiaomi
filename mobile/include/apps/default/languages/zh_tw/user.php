...
$_LANG['not_history'] = "暫無瀏覽記錄，點擊";
$_LANG['enter'] = "進入";
$_LANG['scan_goods'] = "瀏覽商品";
...
$_LANG['user_history'] = '瀏覽記錄';
$_LANG['user_dndzhbd8'] = '電腦端賬號綁定';
$_LANG['user_shezhi8'] = '設置';
$_LANG['user_shoucang8'] = '收藏';
$_LANG['user_xiaoxi8'] = '消息';
$_LANG['user_medingdan8'] = '我的訂單';
$_LANG['user_dingdan8'] = '全部訂單';
$_LANG['user_daifk8'] = '待付款';
$_LANG['user_daish8'] = '待收貨';
$_LANG['user_daipj8'] = '待評價';
$_LANG['user_tuihuan8'] = '退/換貨';
$_LANG['user_wdqb8'] = '我的錢包';
$_LANG['user_zjgl8'] = '資金管理';
$_LANG['user_yue8'] = '餘額';
$_LANG['user_hongbao8'] = '紅包';
$_LANG['user_jifen8'] = '積分';
$_LANG['user_kefu8'] = '客服服務';
$_LANG['user_fenxiang8'] = '我的分享';
$_LANG['user_weidian8'] = '我的微店';
$_LANG['user_qingkong8'] = '清空';

/* 會員餘額(預付款) */
$_LANG['add_surplus_log'] = '帳戶明細';
$_LANG['view_application'] = '申請記錄';
$_LANG['surplus_pro_type'] = '類型';
$_LANG['repay_money'] = '提現金額';
$_LANG['money'] = '金額';
$_LANG['surplus_type_0'] = '賬戶充值';
$_LANG['surplus_type_1'] = '餘額提現';
$_LANG['deposit_money'] = '充值金額';
$_LANG['process_notic'] = '提現帳號';
...
$_LANG['cancel_order_detail'] = '取消訂單';
$_LANG['pay_money'] = '付款';
...
$_LANG['get_password_by_mobile'] = '簡訊找回';
...
/* 登錄 註冊 */
$_LANG['mobile_login'] = '手機註冊';
$_LANG['emaill_login'] = '郵箱註冊';

$_LANG['login'] = '登錄';
$_LANG['sms_code_error'] = '驗證碼不匹配';
$_LANG['mobile_code_error'] = '手機驗證碼錯誤';
$_LANG['register_back'] = '重新註冊';
$_LANG['msg_mobile_blank'] = '手機號不能為空';
...
$_LANG['now_landing'] = '立即登錄';
$_LANG['free_registered'] = '免費註冊';
$_LANG['third_login'] = '使用合作賬號登錄';
$_LANG['no_register_auth'] = '還沒有註冊該插件，請與後台管理員聯繫';
$_LANG['msg_un_blank'] = '用戶名不能為空';
$_LANG['msg_mast_length'] = '用戶名必須為3-15個字元';
...
$_LANG['sms_signin_register'] = '提示：手機號註冊, 驗證碼即是登錄密碼, 請妥善保存！';  //by yang
...
$_LANG['passport_js']['username_longer'] = '- 用戶名長度不能超過15個字元。';
...
$_LANG['can_not_empty'] = '不能為空';

$_LANG['apply_sale_wait'] = '您的申請已提交，請等待管理員同意';
$_LANG['label_fenxiao2'] = '我的分銷';
$_LANG['label_fenxiao'] = '我要分銷';
$_LANG['apply_sale_wait2'] = '已提交申請,請等待審核';
$_LANG['apply_sale_wait3'] = '購買任意一件商品後自動成為分銷商';
/**
 * 售後服務申請  ECTOUCH Leah
 */
$_LANG['rf'][RF_APPLICATION] = '買家發起了申請';
$_LANG['rf'][RF_SEND_OUT] = '買家退回商品';
$_LANG['rf'][RF_RECEIVE] =  '收到退換貨';
$_LANG['rf'][RF_SWAPPED_OUT] =  '換出商品寄出';
$_LANG['rf'][RF_COMPLETE] =  '完成';
$_LANG['rf'][RF_CANCELED] =  '買家撤銷了申請';
$_LANG['rf'][RF_APPLY_FALSE] =  '審核失敗';
$_LANG['ff'][FF_REFUND] = '已退款';
$_LANG['ff'][FF_NOREFUND] = '未退款';

$_LANG['st'][ST_RETURN_GOODS] = '退貨退款';
$_LANG['st'][ST_REFUND] = '僅退款';
$_LANG['st'][ST_EXCHANGE] = '換貨';
$_LANG['st'][ST_REPAIR] = '維修';

$_LANG['rd'][RF_APPLICATION] = "發起了%s， 原因：%s。";
$_LANG['rd'][RF_CANCELED] = "買家主動撤銷了本次售後服務申請";

$_LANG['return_info'] = "退換貨申請已提交";
$_LANG['cancel_service'] = '賣家撤銷了申請';
$_LANG['cancel_service_mess'] = '買家主動撤銷了本次售後服務申請。';

$_LANG['return_not_null'] = '發貨信息不全';

//退換貨語言 by ECTouch Leah begin
$_LANG['aftermarket_apply'] ="申請服務";
$_LANG['return_reason'] = '退貨原因';
$_LANG['exchange_reason'] = '換貨原因';
$_LANG['refund_amount'] = '退款金額';
$_LANG['max_num'] = '最多';
$_LANG['include_shipping_free'] = '元，含發貨郵費';
$_LANG['yuan'] = '元';
$_LANG['return_explain'] = '退貨說明';
$_LANG['aftermarket_type'] ="退換貨類型";
$_LANG['aftermarket_list_lnk'] = '退換貨訂單';
$_LANG['aftermarket_status'] = '退換貨單狀態';
$_LANG['refund_status'] = '退款狀態';
$_LANG['aftermarket_number'] = '服務單號';
$_LANG['should_return'] = '應退款';
$_LANG['return_num'] = '退貨數量';
$_LANG['aftermarket_addtime'] = '申請時間';
$_LANG['aftermarket_detail'] = '服務詳情';
$_LANG['aftermarket_action'] = '操作記錄';
$_LANG['cancel_service'] = '撤銷申請';
$_LANG['cancel'] = '撤銷申請';
$_LANG['send_out'] = '退回商品寄出';
$_LANG['apply_goods'] ="申請售後商品:";
$_LANG['shipping_number'] = '發貨單';
$_LANG['cert_img'] = '憑證圖片';

$_LANG['service_param_err'] = "參數不完整";
$_LANG['service_no_exist'] = "服務類型不存在";

/**退換貨提交顯示語言**/
$_LANG['aftermarket_apply_error'] = '該商品已經申請過，請核實後申請';
$_LANG['wait_check'] ="待審核";
$_LANG['check_false'] ="審核不通過";
$_LANG['refund_success'] ="退款成功";
$_LANG['check_success'] ="審核成功,待退貨";
$_LANG['send_out_repeat'] = '已經發貨，請勿重複提交！';
$_LANG['no_service'] ="當前還不能提交售後服務";
$_LANG['time_out'] = '申請服務已關閉，申請超過設定時間';