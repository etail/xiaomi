...
$_LANG['notice_use_new_pre'] = '只有在恢復全部備份時才可以選擇「是」，否則沒有備份的表將無法使用。<br />您也可以手動修改 data/config.php 中的 $prefix 變數來決定使用哪個表前綴';$_LANG['upload_and_exe'] = '上傳並執行sql文件';
...
$_LANG['unrecognize_version'] = '不能識別備份sql的系統版本';
...
$_LANG['version_error'] = '當前版本%s與備份數據版本%s不同，備份恢復失敗';
$_LANG['not_sql_file'] = '你上傳的好象不是sql文件，如果文件確實是sql文件，請將文件擴展名改為.sql';
...
$_LANG['restore_confirm'] = '恢復資料庫會清除現有的所有內容，您確定要恢復嗎？';
$_LANG['fail_import'] = '數據導入失敗';
$_LANG['no_file'] = '文件不存在';
$_LANG['not_support_zip_format'] = '伺服器不支持zip格式，請將文件解壓後再上傳';
