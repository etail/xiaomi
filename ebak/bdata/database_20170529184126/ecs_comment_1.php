...
E_D("replace into `ecs_comment` values('101','0','27','123456@123.com','','buc水水水水','5','1445500847','103.198.60.160','1','0','0');");
E_D("replace into `ecs_comment` values('102','0','79','123456@123.com','','怎么会没有人评论','5','1445501227','103.198.60.160','1','0','0');");
E_D("replace into `ecs_comment` values('103','0','45','123@798.com','','公司的归属感','5','1446576885','113.81.209.34','1','0','0');");
E_D("replace into `ecs_comment` values('104','0','45','432432@213.cc','','546456','2','1447355689','222.78.54.16','1','0','0');");
E_D("replace into `ecs_comment` values('105','0','43','785094371@qq.com','','dwedwe','2','1448050845','183.38.75.180','1','0','0');");
E_D("replace into `ecs_comment` values('106','0','53','flfadwl@akli.cn','leen','hahaha','4','1448538498','117.95.132.53','1','0','46');");
E_D("replace into `ecs_comment` values('107','0','53','flfadwl@akli.cn','leen','ces ','1','1448538536','117.95.132.53','1','0','46');");
E_D("replace into `ecs_comment` values('108','0','40','www@126.com','','0000000000000000','5','1449363910','27.200.86.109','1','0','0');");
