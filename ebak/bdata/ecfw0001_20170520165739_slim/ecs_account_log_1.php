...
E_D("replace into `ecs_account_log` values('66','20','1.00','0.00','0','0','1445420871','充值','0');");
E_D("replace into `ecs_account_log` values('67','0','100.00','-100.00','0','0','1446771391','解冻拍卖活动的保证金：拍卖小米手机4','99');");
E_D("replace into `ecs_account_log` values('68','46','0.00','0.00','0','0','1448596690','订单 2015112783953 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('69','51','11.50','0.00','0','0','1490755031','订单退款：2016121245486','99');");
E_D("replace into `ecs_account_log` values('70','51','0.00','0.00','18400','18400','1490812746','订单 2016121245486 赠送的积分','99');");
