...
$_LANG['dwt_not_written'] = '模板文件 %s 沒有修改許可權，該模板文件將無法修改';
$_LANG['update_dwt_success'] = '模板內容已經更新成功。';
$_LANG['update_dwt_failed'] = '編輯模板內容失敗。請檢查 %s 目錄是否可以寫入。';
...
$_LANG['template_libs']['asynclist_index'] = '首頁非同步載入商品';
$_LANG['template_libs']['asynclist_info'] = '非同步載入商品';
$_LANG['template_libs']['goods_list_topic'] = '專題列表商品';
$_LANG['template_libs']['goods_list_exchange'] = '積分商城列表商品';
