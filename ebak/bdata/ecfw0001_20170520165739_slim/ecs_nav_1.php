...
E_D("replace into `ecs_nav` values('33','','0','小米网','1','7','0','index.php','top');");
E_D("replace into `ecs_nav` values('34','','0','MIUI','1','8','0','#','top');");
E_D("replace into `ecs_nav` values('35','','0','米聊','1','9','0','#','top');");
E_D("replace into `ecs_nav` values('36','','0','游戏','1','10','0','#','top');");
E_D("replace into `ecs_nav` values('37','','0','多看阅读','1','11','0','#','top');");
E_D("replace into `ecs_nav` values('38','','0','云服务','1','12','0','#','top');");
E_D("replace into `ecs_nav` values('39','','0','小米网移动版','1','13','0','#','top');");
...
E_D("replace into `ecs_nav` values('45','c','118','小米生活方式','0','5','0','category.php?id=118','middle');");
...
E_D("replace into `ecs_nav` values('56','','0','团购商品','1','6','0','group_buy.php','middle');");
