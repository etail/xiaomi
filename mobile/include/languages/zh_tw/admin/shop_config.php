...
$_LANG['cfg_name']['sms_ecmoban_user'] = '簡訊寶用戶名';
$_LANG['cfg_name']['sms_ecmoban_password'] = '簡訊寶密碼';
...
$_LANG['cfg_desc']['sms_shop_mobile'] = '還沒有簡訊寶賬號，<a href="http://www.smsbao.com" target="_blank" style="color:#1B9AD5;">立即註冊</a>';
...
$_LANG['gzip_confirm'] = "GZip 功能需要您的伺服器支持 zlib 擴展庫。\\n如果您發現開啟Gzip後頁面出現亂碼，可能是您的伺服器已經開啟了Gzip，您不需要在商城系統中再次開啟。";
...
$_LANG['sms_url'] = '<a href="'.$url.'" target="_blank">點此註冊手機簡訊服務</a>';
?>