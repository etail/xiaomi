...
$_LANG['shipping_template_info'] = '訂單模板變數說明:<br/>{$shop_name}表示網店名稱<br/>{$province}表示網店所屬省份<br/>{$city}表示網店所屬城市<br/>{$shop_address}表示網店地址<br/>{$service_phone}表示網店聯繫電話<br/>{$order.order_amount}表示訂單金額<br/>{$order.region}表示收件人地區<br/>{$order.tel}表示收件人電話<br/>{$order.mobile}表示收件人手機<br/>{$order.zipcode}表示收件人郵編<br/>{$order.address}表示收件人詳細地址<br/>{$order.consignee}表示收件人名稱<br/>{$order.order_sn}表示訂單號';

/* 表單部分 */
$_LANG['shipping_install'] = '安裝配送方式';
$_LANG['install_succeess'] = '配送方式 %s 安裝成功！';
$_LANG['del_lable'] = '刪除標籤';
...
/* 快遞單部分 */
$_LANG['lable_select_notice'] = '--選擇插入標籤--';
...
$_LANG['lable_box']['shop_tel'] = '網店-聯繫電話';
...
$_LANG['lable_box']['order_postscript'] = '備註-訂單';
...
$_LANG['js_languages']['no_select_lable'] = "操作終止！您未選擇任何標籤。";
$_LANG['js_languages']['no_add_repeat_lable'] = "操作失敗！不允許添加重複標籤。";
$_LANG['js_languages']['no_select_lable_del'] = "刪除失敗！您沒有選中任何標籤。";
