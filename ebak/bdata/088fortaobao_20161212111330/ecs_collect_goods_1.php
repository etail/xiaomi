...
E_D("replace into `ecs_collect_goods` values('9','21','78','1445501445','0');");
E_D("replace into `ecs_collect_goods` values('10','25','93','1445575125','0');");
E_D("replace into `ecs_collect_goods` values('11','17','84','1446137851','0');");
E_D("replace into `ecs_collect_goods` values('12','42','38','1448054237','0');");
E_D("replace into `ecs_collect_goods` values('13','46','80','1448537499','0');");
