...
$_LANG['need_not_setup'] = '當您採用默認會員系統時，無須進行設置。';
$_LANG['different_domain'] = '您設置的整合對象和默認系統不在同一域下。<br />您將只能共享該系統的會員數據，但無法實現同時登錄。';
...
使用方法：
         ...
         3:如果不需要整合任何用戶系統，請選擇安裝插件，即可卸載所有的整合插件。
                           </pre>';
...
$_LANG['ucenter_opt_interface'] = '介面方式';

$_LANG['ucenter_notice_id'] = '該值為當前商店在 UCenter 的應用 ID，一般情況請不要改動';
$_LANG['ucenter_notice_key'] = '通信密鑰用於在 UCenter 和 商城系統 之間傳輸信息的加密，可包含任何字母及數字，請在 UCenter 與 商城系統 設置完全相同的通訊密鑰，以確保兩套系統能夠正常通信';
...
$_LANG['ucenter_notice_db_host'] = '可以是本地也可以是遠程資料庫伺服器，如果 MySQL 埠不是默認的 3306，請填寫如下形式：127.0.0.1:6033';
$_LANG['uc_notice_ip'] = '連接的過程中出了點問題，請您填寫伺服器 IP 地址，如果您的 UC 與 商城系統 裝在同一伺服器上，我們建議您嘗試填寫 127.0.0.1';
...
$_LANG['uc_members_merge'] = '會員合并方式';
$_LANG['user_startid_intro'] = '<p>此起始會員ID為%s。如原 ID 為 888 的會員將變為 %s+888 的值。</p>';
$_LANG['uc_members_merge_way1'] = '將與UC用戶名和密碼相同的用戶強製為同一用戶';
...
$_LANG['uc_client_not_write'] = 'uc_client/data目錄不可寫，請先把uc_client/data目錄許可權設置為777';
