...
E_D("replace into `ecs_order_action` values('49','55','buyer','2','0','0','0','用户取消','1446080755');");
E_D("replace into `ecs_order_action` values('50','56','buyer','2','0','0','0','用户取消','1446080849');");
E_D("replace into `ecs_order_action` values('51','57','buyer','2','0','0','0','用户取消','1446080894');");
E_D("replace into `ecs_order_action` values('52','58','buyer','2','0','0','0','用户取消','1446080973');");
E_D("replace into `ecs_order_action` values('53','80','买家','1','0','2','0','','1448596689');");
E_D("replace into `ecs_order_action` values('54','80','买家','1','1','2','0','','1448596690');");
E_D("replace into `ecs_order_action` values('55','91','admin','1','0','0','0','','1490754625');");
E_D("replace into `ecs_order_action` values('56','91','admin','1','0','2','0','aaa','1490754633');");
E_D("replace into `ecs_order_action` values('57','91','admin','1','0','2','0','aaa','1490812729');");
E_D("replace into `ecs_order_action` values('58','91','admin','1','3','2','0','','1490812733');");
E_D("replace into `ecs_order_action` values('59','91','admin','5','5','2','0','','1490812739');");
E_D("replace into `ecs_order_action` values('60','91','admin','1','1','2','1','','1490812746');");
E_D("replace into `ecs_order_action` values('61','90','admin','1','0','0','0','','1490813745');");
E_D("replace into `ecs_order_action` values('62','90','admin','1','0','2','0','aaa','1490813751');");
E_D("replace into `ecs_order_action` values('63','90','admin','1','3','2','0','','1490813755');");
E_D("replace into `ecs_order_action` values('64','90','admin','5','5','2','0','','1490813762');");
