...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
	...
	/*周欢改 start*/
    //$flash_data_url = ROOT_PATH . DATA_DIR .'/flash_data.xml';
    $flash_data_url = $_SERVER['DOCUMENT_ROOT'] . '/data/flash_data.xml';
	$xml_array=simplexml_load_file($flash_data_url); //将XML中的数据,读取到数组对象中 
	$index_ad_w = array();
	$index_ad_s = array();
