...
E_D("replace into `ecs_admin_action` values('200','0','ext_fenxiao','');");
E_D("replace into `ecs_admin_action` values('201','0','ext_wechat','');");
E_D("replace into `ecs_admin_action` values('138','200','drp_config','');");
E_D("replace into `ecs_admin_action` values('139','200','drp_audit','');");
E_D("replace into `ecs_admin_action` values('140','200','drp_users','');");
E_D("replace into `ecs_admin_action` values('141','200','drp_yongjin','');");
E_D("replace into `ecs_admin_action` values('142','200','drp_order_list','');");
E_D("replace into `ecs_admin_action` values('143','200','drp_affiliate','');");
E_D("replace into `ecs_admin_action` values('144','200','drp_affiliate_ck','');");
E_D("replace into `ecs_admin_action` values('145','200','drp_ranking','');");
E_D("replace into `ecs_admin_action` values('146','200','drp_log','');");
E_D("replace into `ecs_admin_action` values('147','201','wechat_config','');");
E_D("replace into `ecs_admin_action` values('148','201','wechat_masssend','');");
E_D("replace into `ecs_admin_action` values('149','201','wechat_autoreply','');");
E_D("replace into `ecs_admin_action` values('150','201','wechat_selfmenu','');");
E_D("replace into `ecs_admin_action` values('151','201','wechat_tmplmsg','');");
E_D("replace into `ecs_admin_action` values('152','201','wechat_contactmanage','');");
E_D("replace into `ecs_admin_action` values('153','201','wechat_appmsg','');");
E_D("replace into `ecs_admin_action` values('154','201','wechat_qrcode','');");
E_D("replace into `ecs_admin_action` values('155','201','wechat_extends','');");
E_D("replace into `ecs_admin_action` values('156','201','wechat_remind','');");
E_D("replace into `ecs_admin_action` values('157','201','wechat_customer','');");
E_D("replace into `ecs_admin_action` values('158','6','service_type','');");
E_D("replace into `ecs_admin_action` values('159','6','back_cause_list','');");
E_D("replace into `ecs_admin_action` values('160','6','aftermarket_list','');");
E_D("replace into `ecs_admin_action` values('161','6','add_return_cause','');");
E_D("replace into `ecs_admin_action` values('12','0','service_manage','');");
E_D("replace into `ecs_admin_action` values('202','12','service_type','');");
E_D("replace into `ecs_admin_action` values('203','12','back_cause_list','');");
E_D("replace into `ecs_admin_action` values('204','12','aftermarket_list','');");
E_D("replace into `ecs_admin_action` values('205','12','aftermarket_rf_edit','');");
E_D("replace into `ecs_admin_action` values('206','12','aftermarket_rc_edit','');");
E_D("replace into `ecs_admin_action` values('207','12','aftermarket_ff_edit','');");
E_D("replace into `ecs_admin_action` values('208','12','aftermarket_edit','');");
