...
E_D("replace into `ecs_goods_attr` values('93','106','10','21','','0');");
E_D("replace into `ecs_goods_attr` values('94','106','11','蓝','','0');");
E_D("replace into `ecs_goods_attr` values('95','108','14','2','23','0');");
E_D("replace into `ecs_goods_attr` values('96','108','12','樱花粉','34','0');");
E_D("replace into `ecs_goods_attr` values('97','108','13','60cm','23','0');");
E_D("replace into `ecs_goods_attr` values('98','108','12','冰川蓝','43','0');");
E_D("replace into `ecs_goods_attr` values('99','108','12','丁香紫','54','0');");
E_D("replace into `ecs_goods_attr` values('100','108','13','70cm','231','0');");
E_D("replace into `ecs_goods_attr` values('101','108','13','80cm','423','0');");
E_D("replace into `ecs_goods_attr` values('102','108','14','3','12','0');");
E_D("replace into `ecs_goods_attr` values('103','108','14','1','123','0');");
