...
$_LANG['cfg_desc']['sms_shop_mobile'] = '還沒有簡訊寶賬號， <a href="http://www.smsbao.com" target="_blank" style="color:#1B9AD5;">立即註冊</a></span>';
...
$_LANG['cfg_range']['show_asynclist'][1] = '非同步';
...
$_LANG['rewrite_confirm_iis'] = "URL Rewrite 功能要求您的 Web Server 必須安裝IIS，\\n並且起用了 ISAPI Rewrite 模塊。\\n如果您使用的是ISAPI Rewrite商業版，請您確認是否已經將httpd.txt文件重命名為httpd.ini。如果您使用的是ISAPI Rewrite免費版，請您確認是否已經將httpd.txt文件內的內容複製到ISAPI Rewrite安裝目錄中httpd.ini里。";
...
$_LANG['mail_settings_note'] = '如果您的伺服器支持 Mail 函數（具體信息請諮詢您的空間提供商）。我們建議您使用系統的 Mail 函數。<br />當您的伺服器不支持 Mail 函數的時候您也可以選用 SMTP 作為郵件伺服器。';
...
$_LANG['cfg_name']['sms_signin'] = '客戶註冊時是否發送簡訊驗證碼';
...
// 分銷start by WS
$_LANG['cfg_name']['sale'] = '分銷';
$_LANG['cfg_range']['sale']['0'] = '關閉';
$_LANG['cfg_range']['sale']['1'] = '開啟';
$_LANG['cfg_name']['sale_ms'] = '分銷模式';  // 客戶申請分銷模式
$_LANG['cfg_range']['sale_ms']['1'] = '無需審核'; // 點擊我要分銷直接成為分銷商
$_LANG['cfg_range']['sale_ms']['2'] = '需要審核'; // 點擊我要分銷申請，後台管理同意
$_LANG['cfg_range']['sale_ms']['3'] = '購物即可分銷'; // 隨意購買一個商品即可成為分銷商
$_LANG['cfg_range']['sale_ms']['4'] = '購買分銷';    // 購買成為分銷商
$_LANG['cfg_name']['sale_money'] = '購買分銷價格(元)';  // 購買成為分銷商的費用
