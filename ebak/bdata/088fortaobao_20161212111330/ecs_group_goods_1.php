...
E_D("replace into `ecs_group_goods` values('105','45','89.00','12','3');");
E_D("replace into `ecs_group_goods` values('105','30','499.00','12','3');");
E_D("replace into `ecs_group_goods` values('105','32','129.00','12','3');");
E_D("replace into `ecs_group_goods` values('106','27','2200.00','12','1');");
E_D("replace into `ecs_group_goods` values('106','28','1299.00','12','1');");
E_D("replace into `ecs_group_goods` values('106','29','299.00','12','1');");
E_D("replace into `ecs_group_goods` values('107','77','29.00','12','1');");
