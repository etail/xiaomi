...
$_LANG['error_tips'] = '請在商店設置->簡訊設置，先註冊簡訊服務並正確配置簡訊服務！';
...
$_LANG['msg'] = '消息內容';
$_LANG['msg_notice'] = '最長67字元，簽名已經默認，不需要添加簽名。（如未設置簽名點擊 <a href="sms.php?act=sms_sign">設置</a>）';
...
$_LANG['disable_ok'] = '您已經成功註銷簡訊服務。';
$_LANG['disable_error'] = '註銷簡訊服務失敗。';
