...
$shipping_lang = BASE_PATH.'languages/' .C('lang'). '/shipping/qita.php';
...
class yto
{
    ...
    {
        //其他快递查询会判断链接来源，目前的查询无法生效。
        $str = 'http://m.kuaidi100.com/index_all.html?&postid=' .$invoice_sn;
        return $str;
    }
}
