...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','小米商城','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','小米商城','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','小米商城','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','小米商城','1');");
...
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','888888888','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','4001-021-758','1');");
...
E_D("replace into `ecs_shop_config` values('501','5','smtp_host','text','','','smtp.sina.cn','1');");
E_D("replace into `ecs_shop_config` values('502','5','smtp_port','text','','','25','1');");
E_D("replace into `ecs_shop_config` values('503','5','smtp_user','text','','','syp8989@sina.cn','1');");
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','shendukaifa369ok','1');");
E_D("replace into `ecs_shop_config` values('505','5','smtp_mail','text','','','syp8989@sina.cn','1');");
...
E_D("replace into `ecs_shop_config` values('619','6','captcha_height','hidden','','','33','1');");
...
E_D("replace into `ecs_shop_config` values('904','8','sms_ecmoban_user','text','','','shendukaifa','0');");
E_D("replace into `ecs_shop_config` values('905','8','sms_ecmoban_password','password','','','shen111111','0');");
